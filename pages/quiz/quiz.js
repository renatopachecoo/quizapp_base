        ...
        <section class="alternativas">
            <form action="">
                ...
                <label for="alternativa_d">
                    <input type="radio" id="alternativa_d" name="alternativa" vlaue"${alterarSinais(quiz.questions[pergunta-1].options[3])}">
                    <div>
                    <span>D</span>
...
function gardarResposta(evento) {
...
async function iniciar(){
    ...
    inputResposta.forEach(input => {
        input.addEventListener("click", gardarResposta)
    })
}
